  ...
  describe ".cleanup_error" do
    describe "shows the correct position and reduces the clutter" do
      it "for missing attribute in unmanaged-files errors" do
        ...
        expect(subject.cleanup_error(error, "unmanaged_files")).
          to eq(expected)
      end
      ...
      it "for missing attribute in services" do
        ...
        expect(subject.cleanup_error(error, "services")).
          to eq(expected)
      end
      ...
      it "for missing attribute in os" do
        ...
        expect(subject.cleanup_error(error, "os")).
          to eq(expected)
      end
      ...
      it "for wrong attribute type in users" do
        ...
        expect(subject.cleanup_error(error, "users")).
          to eq(expected)
      end
      ...
      it "for unknown repository type and mentions the affected attribute 'type'" do
        ...
        expect(subject.cleanup_error(error, "repositories")).
          to eq(expected)
      end
