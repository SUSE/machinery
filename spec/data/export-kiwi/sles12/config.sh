...
suseImportBuildKey
suseConfig
zypper -n ar --name='SLE-12-SLP' --type='yast2' 'http://dist.suse.de/install/SLP/SLE-12-Server-GM/x86_64/DVD1/' 'SLE-12-SLP'
zypper -n mr --priority=99 'SLE-12-SLP'
...
systemctl enable wickedd.service
